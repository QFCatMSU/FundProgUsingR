...
2.  **Data Programming**: data programming structures and operations like file inputs, vectors, subset operations, plotting, and data types.
    ...
    - **2-5 Which and Substrings:** Conditionally subset string data, finding patterns in string values 

    - **2-6 Regular Expresssions**: Finding complex patterns in strngs

    - **2-7 Datetime Objects:** Formatted date and datetime values, converting from strings to datetime value 

    - **2-8 Matrices:** Create two-dimensional data, performing statistics on 2D data

    - **2-9 Binding and Sampling:** Combining data and creating randomly sampled values
