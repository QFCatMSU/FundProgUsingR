...
Sourcing without echo (option 2) is the preferred way to execute your code and, in this author's opinion, should be the default in Positron (as it is in RStudio) because the Console is much less cluttered and it gives the coder control over the output.[For this class, you should be using Source without echo and assume that the instructor will always be Sourcing your scripts without echo.]{.hl}

 

To make this easier, we will create a keyboard shortcut to ***Source R File*** (without echo):
