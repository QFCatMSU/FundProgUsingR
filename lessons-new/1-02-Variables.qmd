...
It would be best to use the same Project Folder for the whole class and you can use the one you created in the last lesson.

 

To open an Project Folder in Positron (note: both options will show recently opened Project Folders) :
...
Inside your Project, click on ***New -\> New File -\> R File*** (@fig-openNewFile) .  An empty file named ***Untitled-1*** (never leave a file named ***Untitled***) will appear as a tab in the File Editor window.  Save the file as ***lesson1-02.r*** in your ***script*** folder.
...
Lines **1** cleans out the **Variables** within the **Session** tab each time the script is executed (this is often called the Environment). This provides you with a clean slate each time you run a script and I put this line at the top of most of my scripts.

\[Extension: Why clear the Environment?\]
...
In @fig-vdtScript ***dbl*** is put after the values in the Session tab. ***dbl*** is the type of variable, and we will talk much more about this later.

### How to recover panes

Now is a good time to mention that it is pretty easy to accidentally close panes you did not mean to close. If you lose a pane and need it back you can go to ***View -\> Appearances*** to recover it:
