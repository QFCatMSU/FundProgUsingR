...
- Sometimes you need to restart R to get bp to work
...
bp in function \<move to next lesson??\>

bp in package function \<next lesson\>
...
\<Use ***Run -\> Remove All Breakpoints***\>\<move from extension\>
