...
### Positron Issues (will be moved to another document)
...
-   If you lose a pane, you can go to ***View -\> Appearances*** to recover it:

![Toggling the various panes in Positron](images/PositronPanes.png){#fig-panes .fs}

### Differences from RStudio (will become a separate document)
...
-   Working directories / Project Folders:
    ...
    -   RStudio open \*.Rproj files and sets working directory to the folder that contains the RProj file
        ...
        -   [note: the Rproj file does nothing in Positron – it can be kept in the project folder]{.note}
...
9.  A message should appear that you have successfully connected your device – go back to Positron
...
12. In the bottom-right corner of Positron, you will get a pop-up asking if you want Positron to run ***git fetch*** every once in a while – it is better to say ***no*** (but not a big deal)
