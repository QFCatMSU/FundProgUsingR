...
-   default Source is with Echo (in this lesson??)
-   Use Issues or email to hand in apps?
-   Explain how project folders are working directories relate? This is done later in the class
-   Explain how Git is being used in this class and its potential use
-   Positron sometimes slow to load R (antivirus??)
...
-   Use Git and GitHub to save class work
    ...
    -   This is far from a Git/GitHub tutorial – it is just enough to get your work on GitHub
...
For Windows, all installations are straightforward and you can use the default settings. For Macs the installation of Git is a little harder.
...
We are going to use both the ***Console*** and ***Terminal*** tabs inside Positron to execute commands. The Console tab runs programming langauges commands (in this case, R) and the Terminal runs operating system commands. The Terminal tab is linked to Command Prompt (Windows) or Terminal (Mac/Linux).
...
To execute the script, click on the right arrow. This will execute your entire script (***Source***).
...
3.  Change the colors in the boxplot (edit lines 16-19)
