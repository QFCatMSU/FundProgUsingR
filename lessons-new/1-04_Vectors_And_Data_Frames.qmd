...
![View of temperature values in Environment](images/R-1-04-TempValue-in-Env-2.png){#fig-environment-view .fs}
...
[This only works if you are in the]{.hl} Project Folder because the Project Folder sets the Working Directory to your Project Folder.
...
![You get a cannot open file error if you try to execute the script outside of your Project Folder](images/R-1-04-OutSideRSP.png){#fig-open-outside-project .fs}
...
If we want to get the high temperature for consecutive days, we can use the sequence-by-one ( **:** ) operator -- often called the simple sequencing operator. The sequence-by-one operator ( **:** ) gives you every integer number between the two values.
