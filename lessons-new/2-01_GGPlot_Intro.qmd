...
### Create the script for the lesson using code in the lesson
...
- Add info about RStudio Projects (\*.Proj) and creating folders two-levels deep
...
## Positron Project Folders and RStudio Projects

The main reason to use Project Folders in Positron is that you can move or share a project without having to change any of the file links. For instance, in the script for this lesson the command to read the data file is:
...
This command will work as long as someone opens your project in a Positron Project Folder. However, most people use RStudio and you might also want to open your project in RStudio. RStudio has a similar feature to Project Folders called RStudio Projects and the command above will work when a project folder is open in RStudio as a RStudio Project.

### Create an RStudio Project

In RStudio, you can make your project folder in RStudio Project by:

- Click ***File*** -\> ***New Project...***

- Choose ***Existing Directory***

- Browse to your Project Folder and click ***Open***

- Click ***Create Project***

 

The only thing that happens is RStudio creates a file in your Project Folder named ***your_project_name.Rproj***. When somebody wants to open your Project in RStudio, they double-click ***your_project_name.Rproj*** and the scripts, and all their file links, will work the same as in Positron.

 

This will not affect Positron at all and Positron just ignores the Rproj file.
...
Next, we add the scatterplot component ***geom_point()***, and map the ***x*** and ***y*** axis to the ***avgTemp*** and ***relHum*** columns from ***weatherData***:
...
### GGplots in the Variables tab

As of July 2026, the plots will appear in Variables with ?? followed by ggplot2::gplot
...
GGplot released version 4.0 in February 2026. One of the big changes was that GGPlot switched from storing plot information in S3 Objects (Lists) to the much more modern S7 object. At this point, Positron does not know how to view an S7 objects so it puts ***??*** (this is not a programming issue, just a ***Variables*** tab issue). I assume that a near-future version of Positron will fix this.
...
In the ***Console***, type `?labs` to get theHelp page for ***ggplot::labs()***:

![Positron will give you suggestions as you type](images/R_2-01_GGPlotHelp.png)

In the ***Help*** tab for ***labs()*** (@fig-help) we see that it has many subcomponents (or arguments) including:
...
![ Using the Help tab to find info about GGPlot components](images/GGP-1-01-labs.png){#fig-help .fs}
...
The ***Help*** tab provides information directly from <https://ggplot2.tidyverse.org/reference/>, which is the official webpage for GGPlot.  
...
A\) Looking at the GGPlot cheat sheet (or the GGPlot functions page) from @sec-components answer the following in comments in your script:
...
B\) Create a scatterplot in GGPlot in your script:
