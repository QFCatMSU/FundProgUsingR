---
title: "1-01: Project Folders"
short: "1-01"
first_lesson: "&nbsp;&nbsp;&nbsp;&#8226; [This will only work after the instructor has accepted the invitation to the repository.]{.note}"
...
This course uses Positron, a new R development environment from the same company that develops RStudio (Posit). Positron is designed to feel familiar to RStudio users while providing improved integration with modern development tools such as Git and GitHub, making it easier to manage projects, track changes, and collaborate effectively. It also includes improved visualization tools, more powerful debugging features, and better support for modern data science workflows.
...
The second command sets the user ***email*** in Git (replace ***Your_GitHub_email*** with the email you used to sign up for GitHub):
...
Testing the git configuration using the Positron Terminal tab
:::
...
[Extension: Positron R Package Manager]
...
When you click **Open** in Positron, you can choose **Open File…** or **Open Folder…**. Most of the time, [you should open a folder first]{.hl} and then open your script from inside the folder.
...
To execute, or [Source]{.hl}, the entire script click on the right arrow.
...
[Note: Steps 4-9 are only done once per computer – they allow GitHub to authenticate your computer and your ID. Subsequent projects will only require steps 1-3 and 10-12.]{.note}
...
Positron, as of May 2026, has added an R package manager to the vertical bar. The package manager makes installing and managing R packages much more convenient. 

![Positron's R Package Manager](images/R-1-01_PositronPackageMgr.png){#fig-packagemgr .fs}

## Extension: Positron slow to load in Windows
...
## Extension: Differences between Positron and RStudio
