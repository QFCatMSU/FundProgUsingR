...
/*** R
#### In this case, cleaning the Environment would mean removing all the C functions...
#rm(list=ls());  # cleans out the Environment every time the code is executed
options(show.error.locations = TRUE);  # show the line number of errors in the Console
library(package="Rcpp");

#### Had to change the file path from data/twoWeekWeatherData.csv
####                               to ../data/twoWeekWeatherData.csv
...
#### Not needed because the CPP is in this file
### This will bring in the four functions inside the .cpp file
#sourceCpp("scripts/ForLoopsInC.cpp");
