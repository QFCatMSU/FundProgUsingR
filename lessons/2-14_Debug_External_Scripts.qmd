...
### gitignore (for those using GitHub to hand in applications)

In this lesson you will be downloading a package named ***pracma*** and saving it to your project folder. This means that, without intervention, the ***pracma*** package will be added to your Git repository. This is not something you want to do because it is not really part of your project and it takes up a lot of space. To avoid adding ***pracma*** to your Git repository, open the ***.gitignore*** file in the root project folder and add the following line:
