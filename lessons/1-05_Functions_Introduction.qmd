...
The [script for the lesson is here](https://raw.githubusercontent.com/QFCatMSU/FundProgUsingR/master/scripts/1-05_FunctionsIntroduction.R)
...
> medianVal2:   NA_real\_

note: NA_real\_ means an NA value that R thinks should be a real number
...
-   
    ...
    -   note: the default value for ***base*** is **exp(1)** = e^1^ = e = 2.71828... (i.e., the natural logarithm)

    -   

-   

4\. Properly read in [this CSV file](/content/DEVELOPMENT/2020/courses/DEV-belinsky-2020-ProgrammingFundamentalsUsingR/R/Lessons/../Data/twoWeekWeatherData_Comma.csv?isCourseFile=true) of the same two week weather data but:
...
2.  What was your level of comfort with the lesson/application?

3.  

4.  What areas of the lesson/application confused or still confuse you?

5.  

6.  What are some things you would like to know more about that are related to, but not covered in, this lesson?
