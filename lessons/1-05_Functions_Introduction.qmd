...
The [script for the lesson is here](#0)
...
If you look in the ***Environment*** tab the values for ***weatherData*** and ***weatherData2*** are exactly the same.![Expanding weatherData and weatherData2 in the Environment tab](images/R-1-05-weatherdata.png){#fig-weatherdata .fs}
