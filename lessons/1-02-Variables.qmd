...
-   (The method I find most useful) Use the Projects dropdown menu in the top-right corner of RStudio (@fig-projDropdown)
...
There are many people who come to this class having already done some R programming and it is most likely they never clear the ***Environment*** when running scripts. This means that variables are persistent and will still be around when another script is executed.
