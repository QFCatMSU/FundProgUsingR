...
# This QMD file is looking for python for unknown reason -- this stops it 
# execute:
engine: markdown
enabled: false
---
...
Adding the error statement also helps you debug your code.  In this case, the error statement tells you that some value (Fog) does not meet any of the conditions and you can use the codeblock attached to the ***else*** statement to provide useful information about what went wrong -- and perhaps suggest a fix.
