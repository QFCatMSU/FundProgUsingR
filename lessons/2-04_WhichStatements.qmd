...
The script for this lesson [can be downloaded here](../scripts/2-04_WhichStatements.R)
...
![Looking at TRUE/FALSE vectors for conditional statements on a vector](images/R-03-07 TF Vector.PNG){#fig-TF_Vector .fs}
