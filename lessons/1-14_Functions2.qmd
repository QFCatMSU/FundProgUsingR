...
-   To choose which of the six conversions to use, create two arguments: ***from*** and ***to*** and use an ***if-else-if*** structure based on ***from*** and ***to*** to pick the exact conversion.
