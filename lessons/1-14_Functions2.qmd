...
-   Why is ***factors*** created as an empty vector in ***findFactors()*** before it is used in the ***for*** loop? What happens if ***factors*** is not created before the ***for*** loop?

-   How would you change ***findFactors()*** to return the number of factors instead the actual factors? In this case, the return only has one value.
